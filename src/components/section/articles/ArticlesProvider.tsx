...
import ArticlesFilteringSidebar from "./ArticlesFilteringSidebar";
...
export default function ArticlesProvider({
    ...
    return (
        <div className="md:grid grid-cols-12 gap-5 items-start">
            {/*  Courses Side Bar  */}
            <ArticlesFilteringSidebar showSidebar={showSidebar} setShowSidebar={setShowSidebar}/>
            {/*  Courses Wrapper  */}
